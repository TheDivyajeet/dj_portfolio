...
---------- Most Selling Products (Top 10 Products) ----------
...
---------- How much money is currently tied up in inventory at the toy stores? ----------
...
---------- Which are the top 3 stores in each location? ----------
